...
//funzioni per calcolare i parametri della curva a S 
...
//funzioni per disegnare le curve a S
...
void Macro_scurve_Vth(TString Dir, TString filei, Float_t xmin = 30 , Float_t xmax = 60, Float_t par0 = 45 , Float_t par1 = 2, Float_t NEVT=50.){
  // ----------------------------------------------------------------------------------------------------------------------------------------    
  Int_t ideb=0;

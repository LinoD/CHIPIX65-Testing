...
#from read_calibration_data import read_calibration_data
...
pixel_TO1,par_a_TO1,par_b_TO1,err_par_a_TO1,err_par_b_TO1 = read_calibration_data("Calibration/FastToT100-IFeed150-CAL-TO1.out")  	#lettura del file di calibrazione di TO1
pixel_TO2,par_a_TO2,par_b_TO2,err_par_a_TO2,err_par_b_TO2 = read_calibration_data("Calibration/FastToT100-IFeed150-CAL-TO2.out")        #lettura del file di calibrazione di TO2

histo_par_a_TO1 = ROOT.TH1F("histo_par_a_TO1","histo_par_a_TO1",50,-1,1)
histo_par_b_TO1 = ROOT.TH1F("histo_par_b_TO1","histo_par_b_TO1",50,0,0.1)
histo_par_a_TO2 = ROOT.TH1F("histo_par_a_TO2","histo_par_a_TO2",50,-1,1)
histo_par_b_TO2 = ROOT.TH1F("histo_par_b_TO2","histo_par_b_TO2",50,0,0.1)

for i in range(0,len(pixel_TO2)):
	pixel_TO2[i] += 1023.
	pixel_TO1[i] -= 1
	histo_par_a_TO1.Fill(par_a_TO1[i])
	histo_par_b_TO1.Fill(par_b_TO1[i])
	histo_par_a_TO2.Fill(par_a_TO2[i])
	histo_par_b_TO2.Fill(par_b_TO2[i])

#for line in open("Calibration/FastToT100-IFeed150-CAL-TO2.out","rb").readlines():
#	print line
...
histo_Qin_signal = ROOT.TH2F("histo_Qin_signal","histo_Qin_signal",64,-0.5,63.5,64,-0.5,63.5)

histo_Qin_signal_size_1_2 = ROOT.TH1F("histo_Qin_signal_size_1_2","histo_Qin_signal_size_1_2",200,-0.5,50000.5)
histo_Qin_signal_size_1_2_TO1 = ROOT.TH1F("histo_Qin_signal_size_1_2_TO1","histo_Qin_signal_size_1_2_TO1",200,-0.5,50000.5)
histo_Qin_signal_size_1_2_TO2 = ROOT.TH1F("histo_Qin_signal_size_1_2_TO2","histo_Qin_signal_size_1_2_TO2",200,-0.5,50000.5)
...
#histo_fill_TO2_column = ROOT.TH1F("histo_fill_TO2_column","histo_fill_TO2_column",64,-0.5,63.5)
#histo_fill_TO2_column_all = ROOT.TH1F("histo_fill_TO2_column_all","histo_fill_TO2_column_all",64,-0.5,63.5)
#histo_fill_TO2_prova_pixel_colpito = ROOT.TH1F("histo_fill_TO2_prova_pixel_colpito","histo_fill_TO2_prova_pixel_colpito",16,-0.5,15.5)
			...
			if(total_events > 1):
				...
				if(noisy_hit == 0):
					...
					if(cluster_size <= 2):
						...
						for f in range(0, count_Q_1_2):
							Q_1_2_array.append(Q_1_2[f])
							Q_1_2_total += Q_1_2[f]
						if(count_Q_1_2 > 0):
							histo_Qin_signal_size_1_2.Fill(Q_1_2_total)
							if(pix_num[0] >=0 and pix_num[0]<= 1023): 
								histo_Qin_signal_size_1_2_TO1.Fill(Q_1_2_total)
							if(pix_num[0] >=1024 and pix_num[0]<= 2047):   
								histo_Qin_signal_size_1_2_TO2.Fill(Q_1_2_total)
	...
	if (kCode == 123):
		if (counter != 13 and counter != 16 and counter != 19 and counter != 22):
			...
			if(counter == 21):
				...
				#	histo_fill_TO2_prova_pixel_colpito.Fill(15-k)
				...
				for m in range(0,count_pix_colpito):
					...
					for g in range(0,count_noisy):
						if(pix_num[0] == int(noisy_pixels[g])):
							noisy_hit = 1         
					if(noisy_hit == 0):
						#histo_fill_TO2_column_all.Fill(column[m])
						#if(count_pix_colpito == 1 and (pix_num[0] > 1023 and pix_num[0] < 2048)):
							#print pixel_colpito[m],pix_num[m],row[m],column[m]
							#histo_fill_TO2_column.Fill(column[0])
				...
				#if(pix_num[0] > 1023 and pix_num[0] < 2048):
				#	histo_fill_TO2_prova_pixel_colpito.Fill(pix_num[0])
				...
				if(count_pix_colpito >= 6):	
					...
					if(pix_num[5] >=0 and pix_num[5]<= 1023): 
						Q = ((ToT_6 - par_a_TO1[pix_num[5]])/(par_b_TO1[pix_num[5]])*48.5) - 1500
						histo_Qin_signal.Fill(column[5],row[5],Q)
					if(pix_num[5] >=1024 and pix_num[5]<= 2047):  
						Q = ((ToT_6 - par_a_TO2[pix_num[5]-1024])/(par_b_TO2[pix_num[5]-1024])*48.5) - 1500
						histo_Qin_signal.Fill(column[5],row[5],Q)
					if(pix_num[5] >=0 and pix_num[5]<= 1023): 
				...
				if(count_pix_colpito >= 5):
					...
					if(pix_num[4] >=0 and pix_num[4]<= 1023): 
						Q = ((ToT_5 - par_a_TO1[pix_num[4]])/(par_b_TO1[pix_num[4]])*48.5) - 1500
						histo_Qin_signal.Fill(column[4],row[4],Q)
					if(pix_num[4] >=1024 and pix_num[4]<= 2047):  
						Q = ((ToT_5 - par_a_TO2[pix_num[4]-1024])/(par_b_TO2[pix_num[4]-1024])*48.5) - 1500
						histo_Qin_signal.Fill(column[4],row[4],Q)
					if(pix_num[4] >=0 and pix_num[4]<= 1023): 
				...
				if(count_pix_colpito >= 4):
					...
					if(pix_num[3] >=0 and pix_num[3]<= 1023): 
						Q = ((ToT_4 - par_a_TO1[pix_num[3]])/(par_b_TO1[pix_num[3]])*48.5) - 1500
						histo_Qin_signal.Fill(column[3],row[3],Q)
					if(pix_num[3] >=1024 and pix_num[3]<= 2047):  
						Q = ((ToT_4 - par_a_TO2[pix_num[3]-1024])/(par_b_TO2[pix_num[3]-1024])*48.5) - 1500
						histo_Qin_signal.Fill(column[3],row[3],Q)
					if(pix_num[3] >=0 and pix_num[3]<= 1023): 
				...
				if(count_pix_colpito >= 3):
					...
					if(pix_num[2] >=0 and pix_num[2]<= 1023): 
						Q = ((ToT_3 - par_a_TO1[pix_num[2]])/(par_b_TO1[pix_num[2]])*48.5) - 1500
						histo_Qin_signal.Fill(column[2],row[2],Q)
					if(pix_num[2] >=1024 and pix_num[2]<= 2047):  
						Q = ((ToT_3 - par_a_TO2[pix_num[2]-1024])/(par_b_TO2[pix_num[2]-1024])*48.5) - 1500
						histo_Qin_signal.Fill(column[2],row[2],Q)
					if(pix_num[2] >=0 and pix_num[2]<= 1023): 
				...
				if(count_pix_colpito >= 2):
					...
					if(pix_num[1] >=0 and pix_num[1]<= 1023): 
						Q = ((ToT_2 - par_a_TO1[pix_num[1]])/(par_b_TO1[pix_num[1]])*48.5) - 1500
						histo_Qin_signal.Fill(column[1],row[1],Q)
					if(pix_num[1] >=1024 and pix_num[1]<= 2047):  
						Q = ((ToT_2 - par_a_TO2[pix_num[1]-1024])/(par_b_TO2[pix_num[1]-1024])*48.5) - 1500
						histo_Qin_signal.Fill(column[1],row[1],Q)
					if(pix_num[1] >=0 and pix_num[1]<= 1023): 
				...
				if(count_pix_colpito >= 1):
					...
					if(noisy_hit == 0):
						...
						if(pix_num[0] >=0 and pix_num[0]<= 1023): 
							Q = ((ToT_1 - par_a_TO1[pix_num[0]])/(par_b_TO1[pix_num[0]])*48.5) - 1500
							histo_Qin_signal.Fill(column[0],row[0],Q)
						if(pix_num[0] >=1024 and pix_num[0]<= 2047):  
							Q = ((ToT_1 - par_a_TO2[pix_num[0]-1024])/(par_b_TO2[pix_num[0]-1024])*48.5) - 1500
							histo_Qin_signal.Fill(column[0],row[0],Q)
						if(pix_num[0] >=0 and pix_num[0]<= 1023): 
							histo_pixel_signal_TO1.Fill(ToT_1)
						if(pix_num[0] >=1024 and pix_num[0]<= 2047):   
							histo_pixel_signal_TO2.Fill(ToT_1)
							#histo_fill_TO2_prova.Fill(pix_num[0])
						if(pix_num[0] >=2048 and pix_num[0]<= 4095): 					
				...
				if(noisy_hit == 0):
					...
					if(cluster_size <= 2 and count_pix_colpito == 2):
						ToT_1_2.append(ToT_2)
						if(pix_num[1] >=0 and pix_num[1]<= 1023): 
							Q = ((ToT_2 - par_a_TO1[pix_num[0]])/(par_b_TO1[pix_num[0]])*48.5) - 1500
							Q_1_2.append(Q)
							count_Q_1_2 += 1
						if(pix_num[1] >=1024 and pix_num[1]<= 2047):   
							Q = ((ToT_2 - par_a_TO2[pix_num[0] - 1024])/(par_b_TO2[pix_num[0] - 1024])*48.5) - 1500
							Q_1_2.append(Q)
							count_Q_1_2 += 1
					if(cluster_size <= 2 and count_pix_colpito <= 2):
						if(pix_num[0] >=0 and pix_num[0]<= 1023): 
			...
			if(ToT_1_2_array[n] < 32):  #Eliminates the ToT overflows
				if(pixel_1_2_array[n] >=0 and pixel_1_2_array[n]<= 1023):
					if(pixel_1_2_array[n] > 63 and pixel_1_2_array[n]%64 > 0): 
						...
						#histo_Qin_signal_size_1_2_corrected.Fill(Q_1_2[n])
				...
				if(ToT_A < 32 and ToT_B < 32): #Eliminates the ToT overflows
					if((pixel_1_2_array[n] >=0 and pixel_1_2_array[n]<= 1023) and (pixel_1_2_array[n-1] >=0 and pixel_1_2_array[n-1]<= 1023)):    #Elimina anche il caso di due pixel in due FE diversi
						if((pixel_1_2_array[n] > 63 and pixel_1_2_array[n-1]> 63) and (pixel_1_2_array[n]%64 > 0 and pixel_1_2_array[n-1]%64 > 0) and ((pixel_1_2_array[n]-1)%64 > 0 and (pixel_1_2_array[n-1]-1)%64 > 0)): #Elimina i pixel ai bordi
							...
							#histo_Qin_signal_size_1_2_corrected.Fill(Total_Q)
							count_clusters_corrected += 1
...
cvs13 = TCanvas("Qin_1_2_corrected","Qin_1_2_corrected")
cvs13.Divide(2,2)
cvs13.cd(1)
histo_Qin_signal_size_1_2.Draw()
cvs13.cd(2)
histo_Qin_signal_size_1_2_TO1.Draw()
cvs13.cd(3)
histo_Qin_signal_size_1_2_TO2.Draw()
ROOT.gStyle.SetOptStat(1)
...
cvs12 = TCanvas("Qin_map","Qin_map")
cvs12.cd(1)
histo_Qin_signal.Draw("COLZ")
#cvs12.cd(2)
#histo_cluster_signal_size_1_2_TO1_corrected.Draw()
#cvs12.cd(3)
#histo_cluster_signal_size_1_2_TO2_corrected.Draw()
...
cvs14 = TCanvas("TO1_calibration","TO1_calibration")
cvs14.Divide(2,1)
cvs14.cd(1)
histo_par_a_TO1.Draw()
cvs14.cd(2)
histo_par_b_TO1.Draw()

cvs15 = TCanvas("TO2_calibration","TO2_calibration")
cvs15.Divide(2,1)
cvs15.cd(1)
histo_par_a_TO2.Draw()
cvs15.cd(2)
histo_par_b_TO2.Draw()

#cvs16 = TCanvas("prova","prova")
#cvs16.Divide(2,2)
#cvs16.cd(1)
#histo_fill_TO2_column.Draw()
#cvs16.cd(2)
#histo_fill_TO2_column_all.Draw()
#cvs16.cd(3)
#histo_fill_TO2_prova_pixel_colpito.Draw()

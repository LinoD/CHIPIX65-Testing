...
filename=Dir+"20170321152539_TO1-CALSWEEP-VTH35_000.out_thr.root";
file1 = TFile(filename, "READ")
h1 = file1.Get("histo_thr")

### 2
##filename=Dir+"20170321131737_TO2-CALSWEEP-VT100_000.out_thr.root";
filename=Dir+"20170321153456_TO1-CALSWEEP-VTH75_000.out_thr.root";
...
filename=Dir+"20170321154407_TO1-CALSWEEP-VTH115_000.out_thr.root"
file3 = TFile(filename, "READ")
h3 = file3.Get("histo_thr")

### 4
#filename=Dir+"20170321132243_TO2-CALSWEEP-VTH180_000.out_thr.root"
filename=Dir+"20170321155510_TO1-CALWEEP-VTH155_000.out_thr.root"
...
### 5
#filename=Dir+"20170321132243_TO2-CALSWEEP-VTH180_000.out_thr.root"
filename=Dir+"20170321180512_TO1-CALSWEEP-VTH35_000.out_thr.root";
file5 = TFile(filename, "READ")
h5 = file5.Get("histo_thr")

### 6
##filename=Dir+"20170321131737_TO2-CALSWEEP-VT100_000.out_thr.root";
filename=Dir+"20170321181442_TO1-CALSWEEP-VTH75_000.out_thr.root";
...
###filename="201702161831_STDPARA_B7-VSCAN-320-6-VTH110.out_thr.root";
##filename=Dir+"20170321132008_TO2-CALSWEEP-VTH140_000.out_thr.root"
filename=Dir+"20170321182356_TO1-CALSWEEP-VTH115_000.out_thr.root"
file7 = TFile(filename, "READ")
h7 = file7.Get("histo_thr")

### 8
#filename=Dir+"20170321132243_TO2-CALSWEEP-VTH180_000.out_thr.root"
filename=Dir+"20170321183518_TO1-CALWEEP-VTH155_000.out_thr.root"
...
h1.GetXaxis().SetTitle("Charge DAC units")
...
h1.GetYaxis().SetRangeUser(0.00, 0.2)
...
Ilegend.AddEntry("60i","Vth = 35 DAC units ","f")
Ilegend.AddEntry("100i","Vth = 75 DAC units ","f")
Ilegend.AddEntry("140i","Vth = 115 DAC units ","f")
Ilegend.AddEntry("180i", "Vth = 155 DAC units","f")
...
title = TLegend(0.15,0.8,0.4,0.85)
title.SetHeader("VFE-synch TO1") 
...
bxData = [35., 75., 115. ,155.]
bthr     = [42.7,59.03,75.74,90.06 ]
...
## cosmetics
mg.SetTitle("")
mg.GetXaxis().SetTitle("Vth DAC units")
mg.GetXaxis().SetTitleSize(0.055)
mg.GetXaxis().SetTitleOffset(0.8)
mg.GetXaxis().CenterTitle()
mg.GetYaxis().SetTitle("Charge DAC units")
...
stitle.SetHeader("VFE-synch TO1") 

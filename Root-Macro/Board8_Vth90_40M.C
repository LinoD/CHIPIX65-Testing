...
//float th[] =  {57.90, 57.04, 56.34, 55.67, 55.27, 55.03, 54.15, 54.40, 54.95, 55.60, 57.85, 61.48, 64.54, 64.73, 63.56, 62.10, 60.16, 58.91};
//float eth[] = {0.10, 0.08, 0.08, 0.08, 0.08, 0.08, 0.08, 0.09, 0.09, 0.10, 0.5, 0.19, 0.16, 0.12, 0.12, 0.10, 0.22, 0.09};
float th[] =  {58.49, 57.58, 56.96, 56.45, 55.86, 55.37, 55.09, 54.95, 55.13, 56.02, 57.83, 61.56, 64.48, 64.91, 64.06, 62.10, 60.26, 59.53};
float eth[] = {0.09, 0.11, 0.09, 0.08, 0.08, 0.08, 0.08, 0.09, 0.09, 0.10, 0.5, 0.19, 0.16, 0.12, 0.12, 0.10, 0.22, 0.09};

//no = media del rumore ottenuto dal fit della distribuzione
//eno = incertezza sulla media del rumore

float no[] = {1.54, 1.53, 1.54, 1.53, 1.53, 1.55, 1.56, 1.62, 1.67, 1.72, 1.75, 1.73, 1.66, 1.63};
...
gsoglia->SetTitle("<Q_{in}>(TPphase)_{40 MHz} con V_{th} = 90 DAC");
...
TF1 *fitQ = new TF1("fitQ","[4]+([0]+[3]*x)/(1-TMath::Exp(-(x-[1])/[2]))",8,34);
...
gfunzionale->SetTitle("F(TPphase)_{40 MHz} con V_{th} = 90 DAC");

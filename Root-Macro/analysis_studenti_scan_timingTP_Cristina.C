...
//	Dir0 = "data/CERN/board4/Annealed/Ifeed75-Vbl350/";
	...
	Dir = Dir0+"";	
    Macro_scurve_C(Dir,file,x1range,x2range,xmin,xmax,par0,par1,NEVT);
	analisiTHR2(Dir,file,320,tmin,tmax,0.,10.,23.); 
    analisiMC(Dir,file,100,20,120,1.,8.); 
	}
	}
...
/*
void TwoDim_Plots_If40_timing1pix(Int_t i)
{
// ===========================================================================================================================
    Float_t xmin, xmax, par0, par1, NEVT;
	xmin = 30;
...
//	Dir0 = "data/CERN/board4/Annealed/Ifeed75-Vbl350/";
    ...
    Dir0 = "C:\Users\CHIPIX65.CHIPIX65TO03\Documents\LabVIEW Data\CHIPIX_data\studenti\Board8\TPphase-scan-40MHz-Ifeed40-1pixel/";	

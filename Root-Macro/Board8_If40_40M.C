...
float th[] = {44.96, 44.78, 44.68, 44.40, 44.46, 44.54, 44.83, 45.16, 45.82, 46.73, 47.65, 48.11, 47.69, 47.20, 46.56, 46.22, 45.77, 45.41};
float eth[] ={0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.10, 0.08, 0.08, 0.08};
...
gsoglia->SetTitle("<Q_{in}>(TPphase)_{40 MHz} con I_{feed} = 40 DAC");
...
TF1 *fitQ = new TF1("fitQ","[4]+([0]+[3]*x)/(1-TMath::Exp(-(x-[1])/[2]))",9,33);
...
gfunzionale->SetTitle("F(TPphase)_{40 MHz} con I_{feed} = 40 DAC");
...
TF1 *fitf = new TF1("fitf","([0]-[1]*(TMath::Exp(-[2]/x)))*(1-[3]*x)",9,33);

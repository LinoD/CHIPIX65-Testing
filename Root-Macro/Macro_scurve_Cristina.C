...
void Macro_scurve_C(TString Dir, TString filei,Float_t x1range = 50,Float_t x2range = 70, Float_t xmin = 30 , Float_t xmax = 60, Float_t par0 = 45 , Float_t par1 = 2, Float_t NEVT=50.){
// ----------------------------------------------------------------------------------------------------------------------------------------    
	Int_t ideb=0;
...
//     cout << " pippo \n";
     ...
     isweep=0;
     counter = 0;     
    if (ipix < x1range || ipix > x2range) continue;
	else {
    while (isweep < nsw)  {
	if(counter== (nsw-1)){
	   file >> dummy1 >> dummy >> dummy >> dummy >> dummy >> dummy >> dummy >> dummy >> dummy; 
...
void Macro_ToT(TString Dir, TString filei, Float_t x1range = 200, Float_t x2range = 400,Float_t xmin = 30 , Float_t xmax = 60, Float_t par0 = 45 , Float_t par1 = 2, Float_t NEVT=50.){
// ----------------------------------------------------------------------------------------------------------------------------------------    
    Int_t ideb=0;
